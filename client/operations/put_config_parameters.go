...
// WithConfig adds the config to the put config params
func (o *PutConfigParams) WithConfig(config PutConfigBody) *PutConfigParams {
	o.SetConfig(config)
	return o
}

// SetConfig adds the config to the put config params
func (o *PutConfigParams) SetConfig(config PutConfigBody) {
	o.Config = config
}
